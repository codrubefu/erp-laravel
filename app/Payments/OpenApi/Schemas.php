...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'model_type', type: 'string', example: 'subscription_user', default: 'subscription_user', enum: ['subscription_user', 'event_occurrence_user'], description: 'Supported payable models: subscription assignments and event participation assignments.'),
        new OA\Property(property: 'model_id', type: 'integer', nullable: true, example: 30, description: 'Identifier from subscription_user or event_occurrence_user, depending on model_type.'),
...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'model_type', type: 'string', example: 'subscription_user', default: 'subscription_user', enum: ['subscription_user', 'event_occurrence_user'], description: 'Use event_occurrence_user for paid event participation.'),
