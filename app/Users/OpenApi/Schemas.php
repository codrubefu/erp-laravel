...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'cnp', description: 'Romanian personal numeric code (CNP).', type: 'string', nullable: true, maxLength: 20, example: '1900101123456'),
        new OA\Property(property: 'ci', description: 'Identity card (CI) series and number.', type: 'string', nullable: true, maxLength: 20, example: 'RT123456'),
