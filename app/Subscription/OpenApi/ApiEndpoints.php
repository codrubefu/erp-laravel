...
class ApiEndpoints
{
    ...
    #[OA\Post(
        ...
        responses: [
            ...
            new OA\Response(response: 422, description: 'Payment is required for paid subscriptions, is not confirmed, belongs to another organization, is linked to another assignment, or transition is invalid.'),
        ],
    )]
